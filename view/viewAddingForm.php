...
<html>
    ...
    <div class="flex-container">
            <form method="post">
                ...
                <input class="text" type="text" name="nameGame" placeholder="Nom du jeu" minlength=1 maxlength=200>
                ...
                <input class="description" type="textarea" name="description" placeholder="Description du jeu">
