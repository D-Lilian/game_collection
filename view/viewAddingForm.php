...
<html>
    ...
    <div class="flex-container">
            <form method="post">
                ...
                <input class="text" type="text" name="editor" placeholder="Editeur de jeu" minlength=1 maxlength=200 required>
                ...
                <input class="text" type="url" name="urlCover" placeholder="URL de la cover" minlength=1 maxlength=500 required>
                <p class="info">URL du site :</p>
                <input class="text" type="url" name="urlWebsite" placeholder="URL du site" minlength=1 maxlength=500 required>
